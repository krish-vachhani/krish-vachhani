...
- 🛠️ Building in public & writing on [X / Twitter](https://x.com/krishvachhani19) about engineering and the business of it
...
- **[PathCraft ↗](https://www.pathcraft.dev/)** - full-stack AI course generator (Next.js · Node · MongoDB · Gemini · Auth0): a modular lesson engine with 5+ content types; 70+ users, 1,300+ tracked events.
- **[Whiteboard ↗](https://whiteboard-app-kohl.vercel.app/)** - browser drawing editor on the raw HTML5 Canvas API: 4+ tools, low-latency imperative rendering, undo/redo history stack, PNG export.
- **[Trustyle ↗](https://www.trustyle.co.in/)** - full-stack business platform (Next.js · Strapi CMS): SSR/SSG, 75+ products with dynamic content management, deployed on Vercel + Render.
...
### 📫 Connect
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230A66C2.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/krishvachhani/)
